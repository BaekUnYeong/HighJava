...
public class T06_ListSortTest {
	...
	public static void main(String[] args) {
		 ...
		 *		위의 예제처럼 정렬 기준을 별도로 구현하고 싶을 때는 Comparator를
		 *		구현하여 사용하면 된다.
		 *
		...
		// 정렬방식을 변경하려면 정렬방식을 결정하는 객체를 만들어서 Collectios.sort()메서드에 인수로 넘겨주면 된다.
...
class Desc implements Comparator<String>{
	 ...
	 * 
	 * - String 객체에서는 정렬을 위해서 comparaTe()메서드가 구현되어 있는데
	 * 	 이 메서드의 반환값은 오름차순에 맞게 반환되도록 구현되어 있다.
	 * 	 (Wrapper클래스와 Data, File클래스에도 구현되어 있다.)
	 */
